  ...
  <main class="main item_edit">
    ...
    <form action="${pageContext.request.contextPath}/controller" method="POST">
      ...
      <div class="item_edit_actions">
        <a class="btn" style="box-sizing: border-box;" href="${pageContext.request.contextPath}/controller?command=vacancy_info&vacancy_id=${vacancy.id}"><fmt:message key="button.cancel" /></a>
