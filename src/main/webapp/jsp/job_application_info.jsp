      ...
      <div class="item_body_top">
        <div class="user_info_top">
          ...
          <h3 style="color: var(--success-color);">
            <fmt:message key="enum.job_application_state.${job_application.state.name()}"/>
          </h3>
        </div>
      ...
      <div class="notes">
        <c:if test="${job_application.state.name() != 'RECENTLY_CREATED'
          ...
          <form action="${pageContext.request.contextPath}/controller" method="POST">
            ...
            <br>
            <textarea class="interview_note" name="preliminary_interview_note" id="preliminary_interview"
