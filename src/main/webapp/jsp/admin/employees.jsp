...
<div class="nav-main">
  ...
  <main class="main">
    <c:choose>
            ...
            <div class="item">
              <div class="item_info">
                ...
                <div class="item_description">
                  ...
                  <c:if test="${employee.isBanned()}"><span style="color: var(--danger-color)"><fmt:message key="messages.banned"/></span>
                  </c:if>
                  <br>
              ...
              <div class="actions">
                <a class="single_action reference" href="${pageContext.request.contextPath}/controller?command=employee_info&user_id=${employee.id}"><fmt:message key="button.open"/></a>
              </div>
            </div>
          </c:forEach>
        </div>
      ...
      <c:otherwise>
        <h3><fmt:message key="messages.no_employees_found" /></h3>
      </c:otherwise>
    </c:choose>
