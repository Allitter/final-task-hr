  ...
  <main class="main item_more">
    ...
    <div class="item_body" style="text-align: start; white-space: normal;">
      <div class="user_info_top">
        <div class="avatar" style="background-image: url(${pageContext.request.contextPath}/download/${employee.avatarPath}); min-width: 150px; min-height: 150px; margin: 20px"></div>
