...
<div class="nav-main">
    ...
    <main class="main item_edit">
        ...
        <form action="${pageContext.request.contextPath}/controller" method="POST">
            ...
            <input name="resume_name" id="name" class="item_name" type="text" value="${resume.name}">
            <br>
            <label for="item_long_desc" style="text-align: left; margin: 10px 0;">Resume:</label>
            <textarea class="item_long_desc" id="item_long_desc" name="item_long_desc" style="width: auto; height: 600px; resize: none;">${resume.text}</textarea>
            <br>
