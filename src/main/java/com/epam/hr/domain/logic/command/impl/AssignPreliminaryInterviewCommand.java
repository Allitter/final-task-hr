...
public class AssignPreliminaryInterviewCommand implements Command {
    ...
    public AssignPreliminaryInterviewCommand(ApplicationService applicationService) {
    ...
    public Router execute(HttpServletRequest request) throws ServiceException {
        ...
        jobApplication = jobApplication.changeState(JobApplicationState.PRELIMINARY_INTERVIEW);
