...
public class AssignTechnicalInterviewCommand implements Command {
    private final ApplicationService applicationService;

    public AssignTechnicalInterviewCommand(ApplicationService applicationService) {
    ...
    public Router execute(HttpServletRequest request) throws ServiceException {
        ...
        jobApplication = jobApplication.changeState(JobApplicationState.TECHNICAL_INTERVIEW);
